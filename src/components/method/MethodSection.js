  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Commonwealth Rehab, we firmly stand that without addressing
          ...
          <br />
          <br />
          Methods used by Commonwealth Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Commonwealth Rehab promotes fun activities that clients learn how to
