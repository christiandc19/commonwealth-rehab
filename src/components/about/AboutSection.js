      ...
      <div className="about-container">
        <div className="about-content container">
          ...
          <div className="about-content-right">
            <h1>About Us</h1>
            <p>
            Welcome to Commonwealth Rehab, where hope finds a home and healing begins. We are a dedicated team of compassionate professionals committed to supporting individuals and families in their journey towards mental well-being and recovery from addiction.
            </p>
