  ...
  return (
    <>
      <div className="mh-cards-header container">
        <h1>
          COMMONWEALTH REHAB TREATMENT CENTER OFFERS VARIOUS MENTAL HEALTH
          PROGRAMS
        </h1>
        <p>
          At Commonwealth Rehab Treatment Center, clients receive individual
        ...
        <div class="mh-tile">
          ...
          <div class="mh-text">
            ...
            <p class="mh-animate-text">
              ...
              are dealing with, there’s something for everyone at Commonwealth.
            </p>
            <div class="mh-animate-text">
              <LinkRoll
                activeClass="active"
