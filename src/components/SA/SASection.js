...
<div className="sa-cards-header container">
                <h1>COMMONWEALTH REHAB OFFERS VARIOUS SUBSTANCE ABUSE PROGRAMS </h1>
                <p>AtCommonwealth Rehab Treatment Center, clients receive individual therapy alongside a range of additional treatments, including relapse prevention, trauma therapy, mindfulness meditation, transportation, yoga, and more. We offer support that clients need to allow them to gradually go back to treatment. </p>
            </div>
